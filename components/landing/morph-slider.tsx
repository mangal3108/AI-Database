...
function makeFallbackTexture(gl: Renderer['gl']) {
  const size = 4
...
export default function MorphSlider({
  ...
  const optsRef = useRef<MorphEngineOptions | undefined>(undefined)
